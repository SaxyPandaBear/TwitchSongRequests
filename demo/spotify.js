...
async function retrieveSpotifyOauthToken(
    clientId,
    clientSecret,
    authorizationCode
) {
...
retrieveSpotifyOauthToken(
    ...
    getDevices(oauth.access_token).then((found) => {
        ...
        if (computer === null) {
            ...
            queueSong(oauth.access_token, computer, songUri).then((res) => {
