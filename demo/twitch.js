 ...
 */
async function retrieveTwitchOauthToken(clientId, clientSecret, authorizationCode) {
...
retrieveTwitchOauthToken(credentials.twitch_client_id, credentials.twitch_client_secret, credentials.twitch_auth_code)
    .then((oauth) => {
